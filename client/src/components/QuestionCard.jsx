...
export default function QuestionCard({ current, asked, total }) {
  ...
  return (
    <div className="glass relative overflow-hidden p-6 sm:p-8">
      <div className="mb-5 flex items-center justify-between text-xs font-semibold tracking-widest text-slate-400 uppercase">
        ...
        <AnimatePresence mode="wait">
          {current ? (
            <motion.p
              ...
              className="text-center text-2xl leading-snug font-bold text-white sm:text-3xl"
            >
            ...
            <motion.p
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="text-center text-base font-medium text-slate-500"
            >
              {t('question.waiting')}
            </motion.p>
          )}
      ...
      {current && (
        <p className="mt-5 flex items-center justify-center gap-2 text-center text-sm text-slate-400">
